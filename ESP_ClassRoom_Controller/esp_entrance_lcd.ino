...
void loop() {
//  Serial.println(calculateDistance(1));
//  Serial.println(calculateDistance(2));
  if (esp.available()) {
  ...
  if (passedOne && passedTwo) {
    if (calculateDistance(1) < 50 || calculateDistance(2) < 50) {
